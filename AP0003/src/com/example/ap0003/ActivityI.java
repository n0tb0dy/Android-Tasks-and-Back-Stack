...
public class ActivityI extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d(TAG, "ActivityI: onCreate(" + getTaskId() + ")");
	...
	protected void onStart() {
		super.onStart();
		Log.d(TAG, "ActivityI: onStart(" + getTaskId() + ")");
	}
	...
	protected void onResume() {
		...
		setTitle(getResources().getString(R.string.app_name) + " | "
				+ getLocalClassName() + " | TaskID: " + getTaskId());
		Log.d(TAG, "ActivityI: onResume(" + getTaskId() + ")");
		...
		for (RunningTaskInfo task : list) {
			if (task.id == getTaskId()) {
				...
				// Активностей
				tvTextLife = (TextView) findViewById(R.id.textActCountI);
	...
	protected void onPause() {
		...
		tvTextLife = (TextView) findViewById(R.id.textStateActI);
		// присваиваем значение атрибуту Text для выбранного TextView
		tvTextLife.setText("Этот экземпляр ActivityI уже был запущен!");
		Log.d(TAG, "ActivityI: onPause(" + getTaskId() + ")");
	}

	@Override
	protected void onStop() {
		super.onStop();
		Log.d(TAG, "ActivityI: onStop(" + getTaskId() + ")");
	}

	@Override
	protected void onRestart() {
		super.onRestart();
		Log.d(TAG, "ActivityI: onRestart(" + getTaskId() + ")");
	}

	@Override
	protected void onDestroy() {
		super.onDestroy();
		Log.d(TAG, "ActivityI: onDestroy(" + getTaskId() + ")");
	}

	public void onClickStartA(View v) {
		Intent intent = new Intent(ActivityI.this, ActivityA.class);
