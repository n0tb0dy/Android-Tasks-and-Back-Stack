...
public class ActivityH extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.layout_h);
		setTitle(getResources().getString(R.string.app_name) + " | "
				+ getLocalClassName() + " | TaskID: " + getTaskId());
		Log.d(TAG, "ActivityH: onCreate(" + getTaskId() + ")");
	...
	protected void onStart() {
		super.onStart();
		Log.d(TAG, "ActivityH: onStart(" + getTaskId() + ")");
	}
	...
	protected void onResume() {
		...
		setTitle(getResources().getString(R.string.app_name) + " | "
				+ getLocalClassName() + " | TaskID: " + getTaskId());
		Log.d(TAG, "ActivityH: onResume(" + getTaskId() + ")");
		...
		for (RunningTaskInfo task : list) {
			if (task.id == getTaskId()) {
				...
				// Активностей
				tvTextLife = (TextView) findViewById(R.id.textActCountH);
	...
	protected void onPause() {
		...
		tvTextLife = (TextView) findViewById(R.id.textStateActH);
		// присваиваем значение атрибуту Text для выбранного TextView
		tvTextLife.setText("Этот экземпляр ActivityH уже был запущен!");
		Log.d(TAG, "ActivityH: onPause(" + getTaskId() + ")");
	}

	@Override
	protected void onStop() {
		super.onStop();
		Log.d(TAG, "ActivityH: onStop(" + getTaskId() + ")");
	}

	@Override
	protected void onRestart() {
		super.onRestart();
		Log.d(TAG, "ActivityH: onRestart(" + getTaskId() + ")");
	}

	@Override
	protected void onDestroy() {
		super.onDestroy();
		Log.d(TAG, "ActivityH: onDestroy(" + getTaskId() + ")");
	}

	public void onClickStartA(View v) {
		Intent intent = new Intent(ActivityH.this, ActivityA.class);
